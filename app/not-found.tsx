...
export default function NotFound() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col items-start justify-center gap-4 px-6 py-10 text-slate-100">
      <p className="text-sm font-semibold text-slate-400">En construction</p>
      <h1 className="text-3xl font-semibold text-white">Cette page arrive bientôt</h1>
      <p className="text-slate-300">Nous préparons encore ce contenu. Revenez vite ou explorez les sections déjà disponibles.</p>
